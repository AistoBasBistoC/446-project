...
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[5]}]
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[0]}]
set_property PACKAGE_PIN L16 [get_ports {Stop[0]}]
set_property PACKAGE_PIN M13 [get_ports {Stop[1]}]
set_property PACKAGE_PIN R15 [get_ports {Stop[2]}]
set_property PACKAGE_PIN R17 [get_ports {Stop[3]}]
set_property PACKAGE_PIN T18 [get_ports {Stop[4]}]
set_property PACKAGE_PIN U18 [get_ports {Stop[5]}]

set_property PACKAGE_PIN R13 [get_ports {Stop[6]}]
set_property PACKAGE_PIN T8 [get_ports {Stop[7]}]
set_property PACKAGE_PIN U8 [get_ports {Stop[8]}]
set_property PACKAGE_PIN R16 [get_ports {Stop[9]}]
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[9]}]
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[8]}]
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[7]}]
set_property IOSTANDARD LVCMOS18 [get_ports {Stop[6]}]
